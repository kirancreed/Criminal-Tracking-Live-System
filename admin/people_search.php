                ...
                <div class="col-md-12">
                    <form method="get" action="">
                        <div class="input-group">
                            <input type="text" name="search" class="form-control" placeholder="Search by name, state, district, or panchayath">
				...
				<div class="col-lg-12 m-b30">
					<div class="widget-box">
						<div class="wc-title">
							...
							if ($search) {
								$query = "SELECT * FROM people WHERE name LIKE :search OR state LIKE :search OR dstrct LIKE :search OR pncth LIKE :search";
