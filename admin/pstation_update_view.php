<?php
	...
	$result = $db->prepare("select * from pl_station where poli_id='$poli_id'");
	$result->execute();
			...
			<div class="row">
				...
				<div class="col-lg-12 m-b30">
					<div class="widget-box">
						<div class="wc-title">
							<h4>Update Police Station</h4>
						</div>
						<div class="widget-inner">
		<form class="edit-profile m-b30" method="post" action="action/pol_update.php" enctype="multipart/form-data">
								<div class="row">
									<div class="col-12">
										<div class="ml-auto">
