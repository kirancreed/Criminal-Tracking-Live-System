<?php
	...
	$result = $db->prepare("select * from case_reg where case_id='$case_id'");
	$result->execute();
...
<body class="ttr-opened-sidebar ttr-pinned-sidebar">
	...
	<main class="ttr-wrapper">
		...
		<form class="edit-profile m-b30" method="post" action="action/case_update.php" enctype="multipart/form-data" autocomplete="off">
								<div class="row">
									<div class="col-12">
										<div class="ml-auto">
									...
									<div class="form-group col-12">
										...
										<div>
								<textarea class="form-control" name="case" required><?php echo $caser;?></textarea>
										</div>
									</div>	                                 	                                    									
									<div class="col-12">
