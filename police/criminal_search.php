			...
			<div class="row">
				...
				<div class="col-lg-12 m-b30">
					<div class="widget-box">
                        ...
                        if ($search) {
                            $query = "SELECT * FROM crime WHERE name LIKE :search OR age LIKE :search OR sex LIKE :search OR aadharno LIKE :search OR station LIKE :search OR cntno1 LIKE :search";
